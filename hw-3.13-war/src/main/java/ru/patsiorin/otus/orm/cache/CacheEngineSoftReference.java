...
public class CacheEngineSoftReference<K, V> implements CacheEngine<K, V> {
    ...
    @Override
    public Map<String, Object> getParamsAndState() {
        Map<String, Object> params = new HashMap<>();
        params.put("maxElements", maxElements);
        params.put("lifeTimeMs", lifeTimeMs);
        params.put("idleTimeMs", idleTimeMs);
        params.put("isEternal", isEternal);
        params.put("hits", hits);
        params.put("misses", misses);
        return params;
    }
